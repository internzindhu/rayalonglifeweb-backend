...
// Hosted on the sending domain (rayalonglife.com) rather than as a data: URI —
// Gmail and Resend's own deliverability checks flag data: URI images as
// suspicious since they aren't served from a domain the recipient can verify.
const HEADER_WAVE = 'https://www.rayalonglife.com/email-wave.svg';
